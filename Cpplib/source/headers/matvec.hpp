...
namespace icethermo
{
    ...
    template <typename NumType> NumType operator*(const std::vector<NumType>& vec, NumType scal);
    template <typename NumType> NumType operator*(NumType scal, const std::vector<NumType>& vec);
