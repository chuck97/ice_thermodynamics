...
void run_model(NumType time_step,
               ...
               Aparam albedo_ice_parameterization,
...
int main()
{
    ...
    run_model<double>(3600.0,                       // time step (seconds) 
                      ...
                      Kparam::FreshIce,             // ice conductivity parameterization
                      Lparam::FreshIce,             // ice heat of fusion parameterization
